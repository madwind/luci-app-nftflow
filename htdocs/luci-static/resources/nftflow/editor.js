...
function createEditor(options) {
    ...
    function updateState() {
        nftflowUi.setText(byteCount, nftflowUi.formatBytes(editorByteLength(textarea.value)));
    ...
    function setInstalled(value) {
        ...
        nftflowUi.setText(installToggleButton, installed ? _('Uninstall') : _('Install'));
    }
